...
# Set variables
Flash=SpaceX-Kernel_MM_RC2.1_N920S
BK=build_kernel
kernelzip=../zipkernel
model=N920S
...
sed -i -e '/ui_print("~~~~~~~~~ SpaceX Kernel for/c\ui_print("~~~~~~ SpaceX Kernel for Galaxy Note 5 ~~~~~~");' $kernelzip/META-INF/com/google/android/updater-script

sed -i -e '/by ManhIT ~~~~~~~~~~~~~~~");/c\ui_print("~~~~~~~~~~~~~ N920S - by ManhIT ~~~~~~~~~~~~~");' $kernelzip/META-INF/com/google/android/updater-script
