...
# Set variables
Flash=TWRP_3.0.2-1_SCV31_MANHIT
BK=build_kernel
kernelzip=../ziptwrp
model=SCV31
...
sed -i -e '/by ManhIT ~~~~~~~~~~~~~~~");/c\ui_print("~~~~~~~~~~~~~~~ SCV31 - by ManhIT ~~~~~~~~~~~~~~~");' $kernelzip/META-INF/com/google/android/updater-script

sed -i -e '/package_extract_file("boot.img/c\package_extract_file("recovery.img", "/dev/block/platform/15570000.ufs/by-name/RECOVERY");' $kernelzip/META-INF/com/google/android/updater-script
