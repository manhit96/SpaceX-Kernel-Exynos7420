...
# Set variables
Flash=ManhIT_TWRP-3.0.1-0_SC-04G
BK=build_twrp
kernelzip=recoveryzip
model=SC-04G

sed -i -e '/package_extract_file("recovery.img/c\package_extract_file("recovery.img", "/dev/block/platform/15570000.ufs/by-name/RECOVERY");' $kernelzip/META-INF/com/google/android/updater-script
